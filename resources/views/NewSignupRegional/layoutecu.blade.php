...
<script src="{{ asset('regchileasset/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    ...
    <script language="JavaScript" type="text/javascript" src="{{ asset('regchileasset/js/singup/Peru/signupecu.js?v=1.0') }} "></script>
<script language="JavaScript" type="text/javascript" src="{{asset('regchileasset/js/singup/Peru/validationsecu.js?v=1.0')}}"></script>
