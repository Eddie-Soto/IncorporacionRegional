...
<div class="row">
   <div class="col-md-6">
      ...
      <select id="type_per" name="type_person" class="form-control" onchange="getDocuments(); getTypePerson(this.value); ">
        <option value=""></option>
...
<div class="col-md-6" id="rut_natural">
    ...
    <input type="text" id="numberdocument" name="numberdocument" minlength="8" maxlength="8" class="form-control">
</div>
